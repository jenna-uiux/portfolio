        ...
        <div className="group block">
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-lg">
              ...
              <div
                aria-hidden
                className="pointer-events-none absolute inset-0 z-20 bg-[radial-gradient(120%_90%_at_0%_100%,rgba(0,0,0,0.62)_0%,rgba(0,0,0,0.28)_38%,transparent_68%)] opacity-0 transition-opacity duration-500 ease-out group-hover:opacity-100"
              />

              <div
                aria-hidden
                className="pointer-events-none absolute bottom-5 left-6 z-30 flex items-center gap-2 text-[12px] font-medium uppercase tracking-[0.18em] text-white opacity-0 transition-all duration-500 ease-out group-hover:translate-y-0 group-hover:opacity-100 translate-y-3"
              >
